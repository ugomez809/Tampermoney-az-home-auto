...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #${HOST_ID} .rc-counter-submit:hover,
      #${HOST_ID} .rc-counter-submit:focus {
        color: #fff;
        background: #4da3df;
        outline: none;
      }
    ...
    return `
      <div class="rc-counter-options">
        ...
        <div class="rc-counter-options-menu" role="menu">
          <button class="rc-counter-submit" type="button" role="menuitem">Submit</button>
        </div>
      </div>
    `;
  }
